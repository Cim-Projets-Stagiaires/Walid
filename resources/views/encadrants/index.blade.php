                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-link p-0 text-info" style="font-size: 24px;"
                                data-bs-toggle="modal" data-bs-target="#encadrantModal{{ $encadrant->id }}" title="Voir">
                                <i class="ti ti-eye"></i>
                            </a>
                            <a href="{{ route('encadrants.edit', $encadrant->id) }}" class="text-success btn btn-link p-0"
                                style="font-size: 24px;">
