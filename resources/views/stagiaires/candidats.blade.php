                    ...
                    @foreach ($candidatsPaginated as $candidat)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('stagiaires.edit', $candidat->id) }}" class="btn btn-link p-0 text-success"
                                    style="font-size: 24px;">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="deleteModalLabel{{ $candidat->id }}">Confirmer la suppression</h5>
