...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Nous souhaitons vous informer que vous avez un entretien programmé le <strong>{{ $entretien->date }}</strong> à <strong>{{ $entretien->time }}</strong>.</p>
            <p>Veuillez vous préparer à l'heure indiquée et accéder à votre profil pour plus de détails.</p>
