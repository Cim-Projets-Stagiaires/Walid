...
<head>
    ...
    <title>Création de compte Encadrant</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="thank-you-details">
            <p>M/Mme {{ $encadrant->prenom }} {{ $encadrant->nom }},</p>
            <p>Votre compte encadrant a été créé avec succès.</p>
            <p>Vous pouvez vous connecter en utilisant les identifiants suivants :</p>
            <p><strong>Email :</strong> {{ $encadrant->email }}</p>
            <p><strong>Mot de passe :</strong> 123456789</p>
